...
-- This SQL fixes the OAuth authentication issue
...
SELECT 'Básico', 'Plan básico con límite de 50 recibos mensuales', 50, 0
WHERE NOT EXISTS (SELECT 1 FROM plans WHERE nombre = 'Básico');